...
if ('C:\Users\eduar\Desktop\estoque\php\pear ' != '@'.'include_path'.'@ ') {
    ini_set('include_path', trim('C:\Users\eduar\Desktop\estoque\php\pear '). PATH_SEPARATOR .  get_include_path());
    $raw = false;
} else {
